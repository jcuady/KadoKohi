-- Idempotent KADO MENU V2 catalog bootstrap (callable when DB is empty on any environment).
...
REVOKE ALL ON FUNCTION public.kk_ensure_menu_catalog() FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.kk_ensure_menu_catalog() TO anon, authenticated;
