...
export const api = {
  ...
  landing: {
    ...
    addKadoCircleSponsor: useLandingContentStore.getState().addKadoCircleSponsor,
    removeKadoCircleSponsor: useLandingContentStore.getState().removeKadoCircleSponsor,
