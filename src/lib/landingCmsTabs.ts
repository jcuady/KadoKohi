export const LANDING_CMS_TABS = [
  { id: 'hero', label: 'Hero', hint: 'Homepage slider — labels, CTAs, and desktop/mobile backgrounds.' },
  ...
  { id: 'ordering', label: 'How to order', hint: 'Four-step ordering carousel — copy and step icons.' },
  ...
  },
  {
    id: 'about',
    label: 'About page',
    hint: 'Edits /about only (not homepage) — hero accents, soft opening, origins photo.',
  },
  {
    id: 'faq',
    label: 'FAQ',
