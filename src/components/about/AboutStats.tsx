...
export default function AboutStats() {
  return (
    <AboutSectionShell className="border-kado-dark/10 bg-kado-dark py-10 text-kado-cream md:py-12">
      <div className="grid grid-cols-2 gap-6 md:grid-cols-4 md:gap-8">
        {ABOUT_STATS.map((stat, i) => (
          ...
          >
            <p className="font-display text-xl font-bold text-kado-cream sm:text-2xl md:text-3xl">{stat.value}</p>
