      ...
      <div className="mx-auto w-full max-w-[1200px]">
        <div className="mb-8 grid items-center gap-6 sm:mb-10 sm:gap-8 lg:grid-cols-[1fr_0.85fr]">
          <div className="min-w-0 text-center lg:text-left">
            <p className="kado-label mb-2 text-kado-red sm:mb-3">{badge}</p>
            <h2 className="text-balance font-display text-3xl font-black uppercase leading-[0.95] tracking-tight sm:text-4xl md:text-5xl">
              <span style={{ color: MIX_MATCH_BLUE }}>{titleTop}</span>
              <br />
              <span className="text-kado-red">{titleBottom}</span>
            </h2>
            ...
            <div className="flex w-full shrink-0 flex-col items-stretch gap-2 sm:w-auto sm:items-end">
              ...
              {canOrderFeatured ? (
                ...
                >
                  ...
                  <span className="truncate">{featuredCtaLabel}</span>
                </button>
              ) : null}
            </div>
          </article>
